...
// Класс содержит один метод getFiles, который принимает один аргумент - строку path - и возвращает список элементов FileDTO. Однако, метод не содержит никакого реального функционала, а просто возвращает null
@Service
